...
public class ApiDao {
	...
	public void add_employee(String name, String mobile, String address, String gender, Integer salary, Integer age) {
		...
		String sql = "INSERT INTO `employee` (`id`, `name`, `mobile`, `address`, `gender`, `salary`, `age`) VALUES (NULL, '"+name+"', '"+mobile+"', '"+address+"', '"+gender+"', '"+salary+"', '"+age+"');";
	...
	public void add_customer(String name, String mobile, String address, String gender, String email) {
		...
		Session session = sf.getCurrentSession();
		String sql = "INSERT INTO `customer` (`id`, `name`, `mobile`, `address`, `gender`, `email`) VALUES (NULL, '"+name+"', '"+mobile+"', '"+address+"', '"+gender+"', '"+email+"');";
		session.createSQLQuery(sql).executeUpdate();
	}
	...
	public void add_product(String company, String model, Integer price) {
		// TODO Auto-generated method stub
		Session session = sf.getCurrentSession();
		String sql = "INSERT INTO `product` (`id`, `company`, `model`, `price`) VALUES (NULL, '"+company+"', '"+model+"', '"+price+"');";
		session.createSQLQuery(sql).executeUpdate();
	}
	...
	public void add_purchase(Integer product_id, Integer quantity) {
		// TODO Auto-generated method stub
		Session session = sf.getCurrentSession();
		String sql = "INSERT INTO `purchase` (`id`, `product_id`, `quantity`, `date`) VALUES (NULL, '"+product_id+"', '"+quantity+"', current_timestamp());";
		session.createSQLQuery(sql).executeUpdate();
	}
	...
	public void add_sales(Integer customer_id, Integer product_id, Integer quantity) {
		// TODO Auto-generated method stub
		Session session = sf.getCurrentSession();
		String sql = "INSERT INTO `sales` (`id`, `customer_id`, `product_id`, `quantity`) VALUES (NULL, '"+customer_id+"', '"+product_id+"', '"+quantity+"');";
		session.createSQLQuery(sql).executeUpdate();
	}
